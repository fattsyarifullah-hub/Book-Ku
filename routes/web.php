...
// Route bawaan breeze 
    Route::middleware('auth')->group(function () {
        Route::get('/account', [ProfileController::class, 'indexCustomer'])->name('customer.index');
        Route::get('/account/edit', [ProfileController::class, 'editCustomer'])->name('customer.edit');
